...
class ViewModel extends AcessoViewModel
{
     ...
     */
    public function __construct(Acesso $acesso, AuthenticationService $authenticationService, AutenticacaoManager $autenticacaoManager, Form $form)
    {
